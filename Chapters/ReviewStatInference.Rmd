...
# Appendix A: Review of Statistical Inference {#CAppA}
...
More details regarding interval estimation based the *mle* of other parameters and distribution families are given in Appendix Chapter \@ref(CAppC).
