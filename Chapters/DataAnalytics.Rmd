...
For illustrative purposes, we assume that two of the six levels differ from the others yet are the same. For example, the [Table 1.6] summary statistics suggest that Schools and the Miscellaneous levels warrant a higher predicted claims amount than the other four levels. For illustrative purposes, we generated 100 claims that follow this pattern (using simulation techniques that will be described in Chapter \@ref(ChapSimulation)).
