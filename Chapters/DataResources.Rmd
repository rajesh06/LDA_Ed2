...
knitr::kable(head(PrintData, n=printnum), align = "cccccccc", caption = "**Motor Vehicle  Data First Five Rows**")  %>%
  kableExtra::kable_classic(full_width = FALSE) %>% 
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), font_size = 10)
PrintData_tail <- tail(PrintData, n=printnum)
rownames(PrintData_tail) <- NULL
knitr::kable(PrintData_tail, align = "cccccccc", caption = "**Motor Vehicle Data Last Five Rows**")  %>%
  kableExtra::kable_classic(full_width = FALSE) %>% 
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), font_size = 10)
```
